...
import {wrapSplits} from "mantlejs/build/transaction/splits/wrap";
import {unwrapsplits} from "mantlejs/build/transaction/splits/unwrap";
import {issueIdentity} from "mantlejs/build/transaction/identity/issue";
import {nubIdentity} from "mantlejs/build/transaction/identity/nub";
...
import {defineOrder} from 'mantlejs/build/transaction/orders/define';
import {sendSplits} from 'mantlejs/build/transaction/splits/send';
import {makeOrder} from 'mantlejs/build/transaction/orders/make';
import {mutateAsset} from 'mantlejs/build/transaction/assets/mutate';
import {cancelOrder} from 'mantlejs/build/transaction/orders/cancel';
import {burnAsset} from 'mantlejs/build/transaction/assets/burn';
import {deputizeMaintainer as dm} from 'mantlejs/build/transaction/maintainers/deputize';
import {provisionIdentity} from 'mantlejs/build/transaction/identity/provision';
import {unprovisionIdentity} from 'mantlejs/build/transaction/identity/unprovision';
import {takeOrder} from 'mantlejs/build/transaction/orders/take';
import {revealMeta} from 'mantlejs/build/transaction/meta/reveal';
import {queryIdentities} from 'mantlejs/build/transaction/identity/query';
import {mintAsset} from "mantlejs/build/transaction/assets/mint";
import {bank} from "mantlejs/build/transaction/bank/sendCoin";
