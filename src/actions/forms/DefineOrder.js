        ...
        if (mutableMetaProperties.length !== 0) {
            ...
            if (immutableProperties.length !== 0) {
                ...
                if (immutableMetaProperties.length !== 0) {
                    ...
                    const defineIdentiyResult = ordersDefine.define(userAddress, "test", userTypeToken, FromId, mutablePropertyValue, immutablePropertyValue, mutableMetaPropertyValue, immutableMetaPropertyValue, 25, "stake", 200000, "block")
